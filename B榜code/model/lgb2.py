...
data=data[['id','target','id_card_exist', 'auth_time_exist', 'phone_head3', 'appl_auth_time', 'bankpred', 'orderpred', 'credit_score','remain', 'chuxuka_count', 'sex', 'qq_bound', 'wechat_bound', 'account_grade', 'age', 'null_count', 'loan_count', 'overtime_delta', 'amt_order_sum', 'amt_order_std', 'phone_num', 'order_count', 'evening_order_count', 'night_order_count', 'weekend_count', 'weekday_mode', 'product_id_null_num', 'order_null_avg', 'bank_rate_avg', 'before_count', 'id_len', 'ordernum_divd', 'idcard_first', 'count_rec_info', 'region_fre', 'fix_phone_fre']
]
...
submit.to_csv('data/submitB_some_feature.csv',index=False)